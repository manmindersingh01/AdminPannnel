    ...
    <div className=' w-full'>
      <div className=' relative'>
        ...
        <div className='w-full h-10 mt-10 px-4 flex justify-between items-center mb-4'>
          <div className=''>
            <span className=' w-40 font-bold  p-2 rounded-md text-gray-700  md:tracking-wide text-xl  '>Frequent products</span>
            <p className=' text-sm text-gray-600'>Here is the list of all the frequent products with their titile , body , description </p>
          </div>
          {/* <Button
